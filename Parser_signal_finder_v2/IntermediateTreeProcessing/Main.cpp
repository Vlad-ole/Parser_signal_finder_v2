...
int main(int argc, char *argv[])
{
	...
	tree_intermediate_obj.num_of_pe_in_event__positive_part_s_int = 200;
	tree_intermediate_obj.signals_x_start = tmp_vec_int_1;
	...
	//		tree_intermediate_obj->num_of_pe_in_event__positive_part_s_int = 22;
	//		
	...
	//		//	//if ((signals_values_x_second[j] * HORIZ_INTERVAL) > 80000 && (signals_values_x_second[j] * HORIZ_INTERVAL) < 150000) 
	//		//	{
	...
	//		/*cout << "data_raw.size() = " << (*data_raw).size() << endl;
	//		TGraph *gr = new TGraph((*data_raw).size(), &(*data_raw)[0], &(*data_raw)[0]);
	//		gr->Draw();*/

	//		//tree_intermediate_obj->tree->Fill();

	//		tree_intermediate->Fill();
	//		
	...
	///*TH1F *h = new TH1F("hist", "hist_", 100, -10, 10);
